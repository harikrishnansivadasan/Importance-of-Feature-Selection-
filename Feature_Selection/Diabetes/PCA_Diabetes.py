...
df_selected.columns = list(selected_feature_names) + ['Target Variable']
df_selected['Target Variable Label'] = df_selected['Target Variable'].apply(lambda x: df['Outcome'][x])

# Write the DataFrame to a new file
df_selected.to_csv('selected_features_diab.csv', index=False)
