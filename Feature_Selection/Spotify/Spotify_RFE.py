...
X_new["track_genre"] = y
X_new.to_csv('Spotify_RFE.csv', index=False)
#----------------------------------------------------------------------------------------#
#----------------------------------------------------------------------------------------#

#Knn_Classifier
X_new = pd.read_csv("Spotify_RFE.csv")
...
df = pd.read_csv("Spotify_RFE.csv")
...
selected_df.to_csv("output_file_RFE.csv", index=False)
X_new_s = pd.read_csv("output_file_RFE.csv")
# split the dataset into training and testing sets
